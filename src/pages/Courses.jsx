        ...
        <>
            ...
            <section id="tracks" className="max-w-6xl mx-auto px-6 pb-6">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold">Course tracks</h2>
                    <p className="text-slate-600 mt-1">Structured, practical programs with a tangible deliverable.</p>
                    </div>
